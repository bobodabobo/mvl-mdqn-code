...
class SAC:
    ...
    def __init__(self,
        ...
        self.q1 = DiscreteQCritic(state_size, action_size).to(self.device)
        self.q2 = DiscreteQCritic(state_size, action_size).to(self.device)
        self.q1_target = DiscreteQCritic(state_size, action_size).to(self.device)
        self.q2_target = DiscreteQCritic(state_size, action_size).to(self.device)
